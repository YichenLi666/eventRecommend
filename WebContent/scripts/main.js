(function() {
  ...
  // dollar sign is a function name
...
function showErrorMessage(msg) {
  ...
  function activeBtn(btnId) {
	...
	// Call initialization at the end
	init();
	
	
	
})(); // run the above function immediately
